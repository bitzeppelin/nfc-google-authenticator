...
public class OtpProvider implements OtpSource {
	...
	@Override
	public String getNextCode(String accountName, String secret)
	...
	private String getCurrentCode(String username, String secret,
			String placeholder) throws OtpSourceException {
		...
		if (type == OtpType.TOTP) {
			...
			otp_state = mTotpCounter.getValueAtTime(Utilities
					.millisToSeconds(mTotpClock.currentTimeMillis()));
		} else if (type == OtpType.HOTP) {
			// For counter-based OTP, the state is obtained by incrementing
			// stored counter.
